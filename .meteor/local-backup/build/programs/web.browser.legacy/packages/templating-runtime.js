    ...
    for (var i = 0; i < views.length; i++) {
      ...
      try {
        if (view === Template.body.view) {
          ...
          var _view$dataVar$curValu;
          Blaze.renderWithData(renderFunc, (_view$dataVar$curValu = view.dataVar.curValue) === null || _view$dataVar$curValu === void 0 ? void 0 : _view$dataVar$curValu.value, parentEl, comment);
        } else {
